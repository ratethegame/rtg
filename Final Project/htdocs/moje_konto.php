    ...
    <div id="main-bot">
      ...
      <div class="block">
        <div class="block-bot">
			...
			<!--PAGE CONTENT-->
			<?php
					$info = file_get_contents('http://localhost/REST_api.php?action=info&nick='.$_SESSION['Username']);
					$info = json_decode($info, true);
					$arr = explode(" ", $info[0]);
					echo "<center><h1><u>Dane konta:</u></h1><br/></center>";
					echo "<h1><b>Nick:</b> ".$arr[0]."</h1><br/>";
					echo "<h1><b>E-mail:</b> ".$arr[1]."</h1><br/>";
					if($arr[2] != "NULL")
						echo "<h1><b>Imię:</b> ".$arr[2]."</h1><br/>";
					if($arr[3] != "NULL")
						echo "<h1><b>Nazwisko:</b> ".$arr[3]."</h1><br/>";
					if($arr[4] == 1)
						echo "<b>Status:</b> administrator<br/><br/>";
					else
						echo "<b>Status:</b> użytkownik<br><br/>";
	
				?>
				<a href="haslo.php">Zmień hasło</a><br/>
				<a href="usun.php" onclick="return confirm('Czy jesteś pewien, że chcesz usunąć konto?');">Usuń konto</a>
				<?php
				/*
					echo "<center><h1><u>Dodane gry:</u></h1><br/></center>";
					
					echo "<center><h1><u>Oceny i komentarze:</u></h1><br/></center>";
				*/
				?>
			</div>
		</div>
