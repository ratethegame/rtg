    ...
    <div id="main-bot">
      ...
      <div class="block">
        <div class="block-bot">
			<div class="block-cnt">
			<!--PAGE CONTENT-->
				<center><h1>Wprowadź dane: </h1></center><br><br>
				<form action="wyswietl_gre.php" method="post">
				<h2>Nazwa gry: </h2>
				<input type="text" name="nazwa_gry" style="width:300px"><br>
				<h2>Gatunek: </h2>
				<input type="text" name="gatunek" style="width:300px"><br>
				<h2>Wydawca: </h2>
				<input type="text" name="wydawca" style="width:300px"><br><br>
