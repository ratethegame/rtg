    ...
    <div id="main-bot">
      ...
      <div class="block">
        <div class="block-bot">
			...
			<!--PAGE CONTENT-->
			<?php
				$premierowe = json_decode(file_get_contents('http://localhost/REST_api.php?action=premiere&liczba=10'), true);
				if(!empty($premierowe))
				{
					echo "<h1><center>PREMIEROWE GRY:<center></h1><br/>";
					foreach ($premierowe as $gra)
						echo "<a href='wyswietl_gre.php?nazwa_gry=".$gra["nazwa"]."'>".$gra["nazwa"]."</a>&nbsp&nbsp&nbsp(".$gra["czas"].")<br/><br/>";
					}
				else
