			...
			<!--PAGE CONTENT-->
				...
				if(!empty($_POST['pass1']) && !empty($_POST['pass2']))
				{
					...
					if($password1 != $password2)
					{
						...
						echo "<p><center>Hasła muszą być takie same! <a href=\"haslo.php\">Spróbuj jeszcze raz</a>.</center></p>";
					}
					else
					{
						...
						{
							echo "<h1><center>BŁĄD!</center></h1>";
							echo "<p><center>Podane hasła zawierają niedozwolone znaki! <a href=\"haslo.php\">Spróbuj jeszcze raz</a>.</center></p>";
						}
						else
						{
							$output = file_get_contents('http://localhost/REST_api.php?action=change&nick='.$_SESSION['Username'].'&haslo='.$password1);
							if($output == "200")
								echo "<h1><center>Poprawnie zmianiono hasło.</center></h1>";
							else
								echo "<center><h1>Wystąpił nieoczekiwany błąd.</h1><br/><a href=\"moje_konto.php\">Spróbuj jeszcze raz</a>.</center>";
						}
					}
				}
				else
				{
				?>
					<form method="post" action="haslo.php" name="registerform" id="registerform">
						<table border="0" style="width:100%" bgcolor="#313131">
							<tr>
								<td style="text-align:right">Nowe hasło:&nbsp;</td>
								<td><input type="password" name="pass1" id="pass1" style="width:200px" required/></td>
							</tr>
							<tr>
								<td style="text-align:right">Potwierdź nowe hasło:&nbsp;</td>
								<td><input type="password" name="pass2" id="pass2" style="width:200px" required/></td>
							</tr>
							<tr><td></td><td><small>Hasło może zawierać tylko małe i duże litery, cyfry 0-9 oraz znaki - . , _</small></td></tr>
						</table>
						<center><input type="submit" name="change" id="change" value="Zmień hasło"/></center>
					</form>
				<?php
				}
				?>
