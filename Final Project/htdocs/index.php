  ...
  <div id="main">
    <div id="main-bot">
      ...
      <div class="block">
        <div class="block-bot">
          <div class="head">
            <div class="head-cnt"> <a href="premierowe_gry.php" class="view-all">więcej...</a>
              <h3>Premiery</h3>
              <div class="cl">&nbsp;</div>
            </div>
          </div>
          <div class="row-articles articles">
            <div class="cl">&nbsp;</div>
			<?php
				$premierowe = json_decode(file_get_contents('http://localhost/REST_api.php?action=premiere&liczba=3'), true);
				foreach($premierowe as $game)
				{
