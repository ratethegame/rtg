        ...
        <div class="block">
          <div class="block-bot">
            <div class="block-cnt">
				...
				Tutaj będą informacje o koncie (wyciągnięte z jasonów za pomocą REST (ale bez hasła)).Usuwanie konta i zmiana hasła do zrobienia<br/>
				<a href="#">Zmień hasło</a><br/>
				<a href="index.php" onclick="return confirm('Czy jesteś pewien, że chcesz usunąć konto?');">Usuń konto</a>			
          </div>
        </div>
      </div>
    </div>
